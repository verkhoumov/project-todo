...
class Tasks_controller extends MY_Controller
{
	 ...
	 *  получить ID новой задачи, статус, название и список меток, а 
	 *  также ссылку на изображение.
	 *  
	 *  @return  void
	 */
	 ...
	 *  указано новое изображение, JS-обработчик должен получить статус, название, 
	 *  список меток и ссылку на новое загруженное изображение.
	 *  
	 *  @return  void
	 */
